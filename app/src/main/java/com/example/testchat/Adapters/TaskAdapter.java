...
public class TaskAdapter extends RecyclerView.Adapter<TaskAdapter.TaskViewHolder> {
    ...
    public TaskAdapter(Agenda context, List<Task> taskList, CreateTaskBottomSheetFragment.setRefreshListener setRefreshListener) {
    ...
    public void showPopUpMenu(View view, int position) {
        ...
        popupMenu.getMenuInflater().inflate(R.menu.menur_reminder, popupMenu.getMenu());
        popupMenu.setOnMenuItemClickListener(item -> {
            switch (item.getItemId()) {
                case R.id.menuDelete:
                    AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(context, R.style.AppTheme);
                ...
                case R.id.menuComplete:
                    AlertDialog.Builder completeAlertDialog = new AlertDialog.Builder(context, R.style.AppTheme);
